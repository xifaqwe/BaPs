...
func (g *GameConfig) gpp() {
	...
	g.gppFunc = []func(){
		...
		g.gppItemExcel,
		g.gppEmblemExcel,
		g.gppAcademyFavorScheduleExcel,
		g.gppAcademyMessangerExcel,
		g.gppGuideMissionExcel,
		g.gppScenarioModeExcel,
		g.gppScenarioModeRewardExcel,
		g.gppCharacterWeaponExcel,
		g.gppCharacterSkillListExcelTable,
		g.gppSkillExcel,
		g.gppRecipeIngredientExcel,
		g.gppCampaignStageExcel,
		g.gppCampaignUnitExcel,
		g.gppWeekDungeonExcel,
		...
		g.gppFurnitureExcel,
		g.gppCafeRankExcel,
		g.gppCafeProductionExcel,
		g.gppIdCardBackgroundExcel,
		g.gppWeekDungeonRewardExcel,
		g.gppCharacterLevelExcelTable,
		g.gppCharacterGearExcel,
		g.gppCharacterPotentialExcel,
		g.gppCharacterPotentialStatExcel,
		g.gppAcademyLocationExcel,
		g.gppAcademyTicketExcel,
		g.gppAcademyZoneExcel,
		g.gppAcademyLocationRankExcel,
		g.gppAcademyRewardExcel,
		g.gppSchoolDungeonRewardExcel,
		g.gppRaidSeasonManageExcel,
		g.gppRaidRankingRewardExcel,
		g.gppRaidStageExcel,
		g.gppCharacterStatExcelTable,
		g.gppRaidStageRewardExcel,
		g.gppMissionExcelTable,
		g.gppRaidStageSeasonRewardExcel,
		...
		g.gppEliminateRaidSeasonManageExcel,
		g.gppEliminateRaidRankingRewardExcel,
		g.gppEliminateRaidStageExcel,
		g.gppEliminateRaidStageRewardExcel,
		g.gppEliminateRaidStageSeasonRewardExcel,

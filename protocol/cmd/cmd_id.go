...
func (c *CmdProtoMap) registerAllMessage() {
	...
	c.regMsg(mx.Protocol_Campaign_EnterMainStageStrategySkip, func() any { return new(proto.CampaignEnterMainStageStrategySkipRequest) }, true)
	c.regMsg(mx.Protocol_Campaign_EnterMainStageStrategySkip, func() any { return new(proto.CampaignEnterMainStageStrategySkipResponse) }, false)
	c.regMsg(mx.Protocol_EventContent_BoxGachaShopList, func() any { return new(proto.EventContentBoxGachaShopListRequest) }, true)
	c.regMsg(mx.Protocol_EventContent_BoxGachaShopList, func() any { return new(proto.EventContentBoxGachaShopListResponse) }, false)
	c.regMsg(mx.Protocol_EventContent_AdventureList, func() any { return new(proto.EventContentAdventureListRequest) }, true)
	c.regMsg(mx.Protocol_EventContent_AdventureList, func() any { return new(proto.EventContentAdventureListResponse) }, false)
	c.regMsg(mx.Protocol_EventContent_ScenarioGroupHistoryUpdate, func() any { return new(proto.EventContentScenarioGroupHistoryUpdateRequest) }, true)
	c.regMsg(mx.Protocol_EventContent_ScenarioGroupHistoryUpdate, func() any { return new(proto.EventContentScenarioGroupHistoryUpdateResponse) }, false)
	c.regMsg(mx.Protocol_TimeAttackDungeon_GiveUp, func() any { return new(proto.TimeAttackDungeonGiveUpRequest) }, true)
